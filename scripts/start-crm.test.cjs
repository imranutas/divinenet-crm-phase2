...
const { configFor, aiDirectory, parseListeners, recordedIdentityMatches, capabilitiesMatch, runtimeArgs, assertDependencies, assertPortFree } = require('./start-crm.cjs');

test('installed backend dependencies pass readiness checks', () => {
