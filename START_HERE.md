# Divinenet CRM — local workspace

Source-download setup clarified 23 September 2026. The application baseline is PR #29, `f10c38a0de73c584eab43c7ea5c2065041ee0498`. Preserve the original dated evidence separately. A GitHub source ZIP does not include Node.js, installed dependencies or AI runtime files: first follow [README.md](README.md#download-and-start-on-windows). Extract into a new folder, never over an existing workspace/database.

1. After installing Node.js 24 and this copy's dependencies as described in README.md, double-click START-CRM.cmd. It opens the local CRM after readiness succeeds. Nothing is downloaded automatically; opening index.html alone does not start the CRM.
